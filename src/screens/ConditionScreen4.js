...
export default function ConditionScreen4({navigation}) {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text
       onPress={()=>navigation.navigate('ConditionScreen5')}
      ...
      >
        ...
        />
        <View>
          <Text style={styles.welcomeTitle}>Congratulation! you made it!</Text>
