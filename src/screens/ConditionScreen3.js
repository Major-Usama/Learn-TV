...
export default function ConditionScreen3({navigation}) {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text
       onPress={()=>navigation.navigate('ConditionScreen4')}
      ...
      >
        ...
        />
        <View>
          <Text style={styles.welcomeTitle}>Sorry ! you did not make it!</Text>
